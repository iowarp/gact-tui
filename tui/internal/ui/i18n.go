...
func (a *App) refreshLocalizedPlaceholders() {
	a.input.Placeholder = a.localizedInputPlaceholderForWidth(0)
}

func (a *App) localizedInputPlaceholderForWidth(width int) string {
	full := a.localizer.t(msgInputPlaceholder, nil)

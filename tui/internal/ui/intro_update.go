...
// introTickMsg advances the animated splash by one
...
// blurred past before the viewer could appreciate it. Users can
// override via config.IntroFrameDelayMs; main.go plumbs

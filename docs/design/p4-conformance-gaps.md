...
| B6 | No **update-check endpoint**, so the version stamp shows the version but cannot claim "update available" as the prototype does. Asserting it would be inventing a fact. | open |

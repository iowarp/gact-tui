...
export const PromptInput = ({
  ...
  const openFileDialogLocal = useCallback(() => {
    ...
    if (typeof input.showPicker === 'function') {
      try {
        ...
        // Browsers may reject showPicker outside their native activation path.
      }
    }
    input.click();
  }, []);
  ...
  // The mounted PromptInput owns this input. Open it directly rather than
...
export const PromptInputTextarea = ({
  ...
  const controlledProps = controller
    ? {
        ...
        value: value ?? controller.textInput.value,
      }
    : {
        onChange,
        value,

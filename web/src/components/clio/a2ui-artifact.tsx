...
export function ClioA2UIArtifact({ action, mediaType, name, size, uri }: ClioA2UIArtifactProps) {
  ...
  return <ClioArtifactCard artifact={artifact} onOpen={action ? () => void action() : undefined} />;
}

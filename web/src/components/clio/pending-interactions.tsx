          ...
          <PlanFooter className="flex-col items-start gap-1 border-t text-xs text-muted-foreground">
            ...
            {plan?.plan_content_status === 'unavailable' ? (
              <span className="text-destructive">
                The saved plan is unavailable. Automatic execution remains unavailable; reject it for
                revision or exit Plan mode without executing.
              </span>
            ) : null}
          </PlanFooter>
        </Plan>

...
const CascaderStateContext = React.createContext<CascaderStateContextValue | undefined>(undefined);
...
const CascaderActionsContext = React.createContext<CascaderActionsContextValue | undefined>(
  undefined,
);

export function useCascaderActions<T = unknown>(): CascaderActionsContextValue<T> {
...
export function useCascaderRender<T = unknown>(): CascaderRenderContextValue<T> {
  return React.useContext(CascaderRenderContext) as CascaderRenderContextValue<T>;
}
...
const CascaderHighlightContext =
  React.createContext<CascaderHighlightStore>(FALLBACK_HIGHLIGHT_STORE);

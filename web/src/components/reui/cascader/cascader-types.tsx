...
export type CascaderLoadReason = 'level' | 'more' | 'prefetch' | 'retry' | 'resolve';
...
export interface CascaderLabels {
  ...
  levelAnnouncement: (parentLabel: string, depth: number, count: number) => string;
  ...
  cascadeAnnouncement: (label: string, count: number, selecting: boolean) => string;

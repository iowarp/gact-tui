...
| CLIO-style event detail | `semantic_event_detail.tape`, `semantic_workflow_state_event.tape`, `codex_part_detail_labels.tape`, `semantic_narrow_operator_surfaces.tape` | `semantic_event_detail.png`, `semantic_event_detail_evidence.png`, `semantic_workflow_state_event_inline.png`, `semantic_workflow_state_event_detail.png`, `codex_part_detail_labels.png`, `semantic_narrow_detail_view.png` | Covered |

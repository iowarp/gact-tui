...
| Memory/search/context frame | `semantic_memory_inspector.tape`, `semantic_memory_search.tape`, `semantic_memory_stress.tape`, `semantic_memory_unavailable.tape` | `semantic_memory_inspector.png`, `semantic_memory_context_frame.png`, `semantic_memory_stress_summary.png`, `semantic_memory_stress_search_hits.png`, `semantic_memory_stress_excluded_file.png`, `semantic_memory_stress_context_frame.png`, `semantic_memory_stress_agent_tools.png`, `semantic_memory_unavailable_palette.png` | Covered |
